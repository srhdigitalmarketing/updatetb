<div class="col-6 col-md-4 col-xl dashboard-metric metric-coverage">
...
<div class="col-6 col-md-4 col-xl dashboard-metric metric-views">
    <div class="tile-stats metric-card">
...
<div class="col-6 col-md-4 col-xl dashboard-metric metric-links">
    <div class="tile-stats metric-card">
...
<div class="col-6 col-md-4 col-xl dashboard-metric metric-requests">
    <div class="tile-stats metric-card">
...
<div class="col-6 col-md-4 col-xl dashboard-metric metric-reported">
    <div class="tile-stats metric-card">
